...
<template>
  ...
  >
    <div class="w-full h-14 relative z-20">
      ...
      >
        <button
          @click="changeTheme"
          class="flex w-full items-center gap-3 h-14"
        >
        ...
        >
          <button class="min-h-12 h-12 px-5 flex items-center gap-3">
    ...
    <button
      ...
      :class="isChangingTheme ? 'bg-red-200 grayscale' : 'hover:bg-neutral-100'"
    ...
    <button
      :disabled="isChangingTheme"
      :class="isChangingTheme ? 'bg-red-200 grayscale' : 'hover:bg-red-100/50'"
  ...
  <DashboardModalsSettings @toggleSettingsModal="toggleSettingsModal" :isSettingsModalActive="isSettingsModalActive" />
</template>
