  ...
  <Transition name="fade">
    ...
    >
      <div class="w-full max-w-lg flex flex-col gap-6">
        ...
        <!-- input -->
        <div
          class="w-full h-14 bg-white rounded-3xl shadow overflow-x-hidden flex items-center"
        >
          <input
            type="text"
            placeholder="Enter url"
            v-model="url"
            class="h-full w-full px-5 text-lg font-normal placeholder:text-neutral-500 outline-none"
          />
          <div class="h-full w-24 shrink-0 flex items-center p-2">
            <button
              @click="submitUrl"
              :disabled="isLoading"
              class="w-full h-full bg-neutral-900 disabled:bg-neutral-700 grid place-items-center text-white rounded-full"
            >
        ...
        <div
          v-else
          class="h-auto min-h-28 w-full max-w-lg bg-white shadow rounded-3xl flex flex-col  overflow-hidden"
        >
          <div class="w-full h-56 overflow-hidden">
            <div class="h-full rounded-t-2xl bg-gray-200 overflow-hidden">
              <img
          ...
          >
            ...
            <div class="flex items-center justify-between font-normal p-4">
              <div class="flex items-center gap-3">
                <div class="size-4 overflow-hidden rounded-full bg-neutral-900">
                  <img
